...
@section('konten')
    ...
    <form action="{{ route('siswa.update', $siswa->NRP) }}" method="POST" onsubmit="return validasiForm()">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="NRP" id="NRP" maxlength="10" value="{{ old('NRP', $siswa->NRP) }}" required>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="Nama" id="Nama" maxlength="20" value="{{ old('Nama', $siswa->Nama) }}" required>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="Kelas" id="Kelas" maxlength="5" value="{{ old('Kelas', $siswa->Kelas) }}" required>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="date" class="form-control" name="TanggalLahir" id="TanggalLahir" value="{{ old('TanggalLahir', $siswa->TanggalLahir) }}" required>
            </div>
        </div>
